...
"Sitemap" plugin helps you show sitemap of the pages with [sitemap] shortcode.

== Description ==

You can use aditional parameters: [sitemap depth="2" child_of="4" exclude="6,7,8"].

Plugin is based on [wp_list_pages](http://codex.wordpress.org/Template_Tags/wp_list_pages)('sort_column=menu_order&title_li=');
